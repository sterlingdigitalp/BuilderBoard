...
pub enum ExecutionEvent {
    ...
    EngineMetadata { key: String, value: String },

    // === Phase 9A Tool Runtime Events ===
    ...
    ToolOutput {
        tool_id: String,
        execution_id: String,
        channel: String, // "stdout" | "stderr" | "result"
        content: String,
    },
    ...
    /// A review item was generated by a mutating tool.
    ReviewItemCreated {
        tool_id: String,
        execution_id: String,
        action: String,
    ...
    /// A timeline entry for this execution.
    TimelineEntry {
        execution_id: String,
        phase: String,
